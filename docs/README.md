...
| `iterations/` | Iteration summaries (multi-version scope) |
| `test-results/` | Test run records per version |

## Release History

| Version | Status | Release Note |
|---------|--------|--------------|
| v0.1.1 | Merged to main | [v0.1.1-backend-shell.md](releases/v0.1.1-backend-shell.md) |
...
| v1.0.0 | In progress | [v1.0.0-polymarket-http-client-pack.md](releases/v1.0.0-polymarket-http-client-pack.md) |
| v1.0.1 | In progress | [v1.0.1-request-signing-auth-pack.md](releases/v1.0.1-request-signing-auth-pack.md) |
